...
AQ_EventFrame:SetScript("OnEvent", function(self, event, ...)
  ...
  if (event=="QUEST_GREETING") then
    ...
    -- print("\124" .. color_debug .. "AutoQuests Log:\nAvailable: " .. npcAvailableQuestCount .. ".\nIn progress: " .. npcActiveQuestCount ..".\124r") -- DEBUG
  ...
  if (event=="QUEST_FINISHED") then
    -- print("\124" .. color_debug .. "AutoQuests Log:\nIs QUEST_FINISHED event.\124r") -- DEBUG
  end

  if (event=="QUEST_DETAIL") then
    -- print("\124" .. color_debug .. "AutoQuests Log:\nIs QUEST_DETAIL event.\124r") -- DEBUG
    AcceptQuest()
  end

  if (event=="QUEST_PROGRESS") then
    -- print("\124" .. color_debug .. "AutoQuests Log:\nIs QUEST_PROGRESS event.\124r") -- DEBUG
    CompleteQuest()
  end
  ...
  if (event=="QUEST_COMPLETE") then
    ...
    -- print("\124" .. color_debug .. "AutoQuests Log:\nReward count: " .. npcQuestRewardsCount .. ".\124r") -- DEBUG
